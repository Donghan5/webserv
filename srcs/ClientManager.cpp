...
// constructor
ClientManager::ClientManager(std::vector<struct pollfd>& poll_fds) : poll_fds(poll_fds) {
...
void ClientManager::handleClientRead(int client_fd) {
	if (client_fd <= 0) {
...
void ClientManager::handleClientWrite(int client_fd) {
...
void ClientManager::closeClient(int client_fd) {
